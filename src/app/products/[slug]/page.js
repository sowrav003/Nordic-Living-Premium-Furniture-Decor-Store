...
const ProductDetails = ({ params }) => {
  ...
  const { addToCart, toggleWishlist, wishlistItems } = useShopStore();
      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            {product.images.map((img, idx) => (
              <button
                ...
                className={`relative w-full h-28 border ${
                  activeImage === idx ? "border-black" : "border-stone-200"
                }`}
              >
                <Image
                  src={img}
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className={`w-14 border flex items-center justify-center ${
                  wished ? "bg-black text-white" : "border-stone-300"
                }`}
              >
        ...
        <section className="mt-24 border-t border-stone-200 pt-10">
          ...
          {activeTab === "description" && (
            <p className="text-stone-600  max-w-4xl">{product.description}</p>
          )}
