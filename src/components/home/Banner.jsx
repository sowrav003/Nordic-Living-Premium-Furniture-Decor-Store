  ...
  return (
      <section className="bg-gray-100 flex justify-center w-full px-16 py-12 md:py-24">
        <div className="relative w-full max-w-7xl aspect-[4/3] md:aspect-[22/9] rounded overflow-hidden shadow-sm group">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-gray-300 via-white/60 to-transparent"></div>
          <div className="relative z-10 h-full flex flex-col items-start justify-center p-8 md:p-20 max-w-2xl">
             <span className="text-[10px] tracking-[0.2em] uppercase text-gray-500 mb-4 font-semibold">The Spring Edit</span>
             <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-gray-900 mb-6 tracking-tight">A softer way to live.</h2>
             ...
             <Link href="/shop" className="bg-[#1a1a1a] text-white px-7 py-3.5 rounded-full text-sm font-medium hover:bg-black transition-colors flex items-center gap-2">
